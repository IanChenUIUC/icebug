...
protected:
    ...
    std::pair<GraphW, InducedSubgraphView> createInducedSubgraphView(count n, count m,
                                                                     bool random = false) const;
    std::pair<GraphW, InducedSubgraphView>
    createInducedSubgraphView(count n, count m, count N, count M, bool random = false) const;
...
std::pair<GraphW, InducedSubgraphView>
InducedSubgraphViewGTest::createInducedSubgraphView(count n, count m, bool random) const {
    // Create bigger E-R graph, and then subset it
    count N = static_cast<count>(n * Aux::Random::real(2, 10));
    count M = static_cast<count>(m * Aux::Random::real(2, 10));
    return createInducedSubgraphView(n, m, N, M, random);
}

std::pair<GraphW, InducedSubgraphView>
InducedSubgraphViewGTest::createInducedSubgraphView(count n, count m, count N, count M,
                                                    bool random) const {
    GraphW G = createGraphW(N);
    while (G.numberOfEdges() < M) {
        const auto u = Aux::Random::index(N);
    ...
    return {G, InducedSubgraphView(G, subset)};
}
...
TEST_P(InducedSubgraphViewGTest, testAddNode) {
    auto [H, G] = createInducedSubgraphView(0, 0, 10, 25);
    ...
    auto [H2, G2] = createInducedSubgraphView(2, 0, 10, 25);
...
TEST_P(InducedSubgraphViewGTest, testAddNodes) {
    InducedSubgraphView G = createInducedSubgraphView(5);
    G.addNodes(5);
...
TEST_P(InducedSubgraphViewGTest, testRemoveNode) {
    auto testInducedSubgraphView = [&](InducedSubgraphView &G) {
    ...
    InducedSubgraphView G1 = ErdosRenyiGenerator(200, 0.2, false).generate();
    InducedSubgraphView G2 = ErdosRenyiGenerator(200, 0.2, true).generate();
...
TEST_P(InducedSubgraphViewGTest, testRestoreNode) {
    InducedSubgraphView G = createInducedSubgraphView(4);
...
TEST_P(InducedSubgraphViewGTest, testIsIsolated) {
...
TEST_P(InducedSubgraphViewGTest, testWeightedDegree) {
    ...
    if (isWeightedInducedSubgraphView()) {
    ...
    if (isDirectedInducedSubgraphView()) {
    ...
    if (isWeightedDirectedInducedSubgraphView()) {
...
TEST_P(InducedSubgraphViewGTest, testAddEdge) {
    InducedSubgraphView G = createInducedSubgraphView(3);

    // InducedSubgraphView without edges
    ...
    // InducedSubgraphView with 2 normal edges
    G.addEdge(0, 1, 4.51);
    G.addEdge(1, 2, 2.39);
...
TEST_P(InducedSubgraphViewGTest, testRemoveEdge) {
    double epsilon = 1e-6;
    InducedSubgraphView G = createInducedSubgraphView(3);
...
TEST_P(InducedSubgraphViewGTest, testRemoveAllEdges) {
    constexpr count n = 100;
    ...
    for (int seed : {1, 2, 3}) {
        ...
        auto g = ErdosRenyiGenerator(n, p, isDirected()).generate();
        if (isWeighted()) {
            g = InducedSubgraphView(g, true, isDirected());
        }
...
TEST_P(InducedSubgraphViewGTest, testRemoveSelfLoops) {
    constexpr count n = 100;
...
TEST_P(InducedSubgraphViewGTest, testRemoveMultiEdges) {
    constexpr count n = 200;
    constexpr double p = 0.1;
    constexpr count nMultiEdges = 10;
    constexpr count nMultiSelfLoops = 10;

    auto getGraphEdges = [](const InducedSubgraphView &G) {
...
TEST_P(InducedSubgraphViewGTest, testIsEmpty) {
    InducedSubgraphView G1 = createInducedSubgraphView(0);
    InducedSubgraphView G2 = createInducedSubgraphView(2);
...
TEST_P(InducedSubgraphViewGTest, testNumberOfEdges) {
    ...
    InducedSubgraphView G1 = createInducedSubgraphView(5);
...
TEST_P(InducedSubgraphViewGTest, testSelfLoopConversion) {
    ...
    for (index i = 0; i < runs; i++) {
        ...
        InducedSubgraphView G(n, false, directed);
        ...
        InducedSubgraphView G_converted(G, false, !directed);
...
TEST_P(InducedSubgraphViewGTest, testCheckConsistency_MultiEdgeDetection) {
    InducedSubgraphView G = createInducedSubgraphView(3);
...
TEST_P(InducedSubgraphViewGTest, testSetWeight) {
    InducedSubgraphView G = createInducedSubgraphView(10);
    G.addEdge(0, 1);
    G.addEdge(1, 2);
...
TEST_P(InducedSubgraphViewGTest, increaseWeight) {
    InducedSubgraphView G = createInducedSubgraphView(5);
    G.addEdge(0, 1);
    G.addEdge(1, 2);
    G.addEdge(3, 4, 3.14);
...
TEST_P(InducedSubgraphViewGTest, testTotalEdgeWeight) {
    InducedSubgraphView G1 = createInducedSubgraphView(5);
    InducedSubgraphView G2 = createInducedSubgraphView(5);
    G2.addEdge(0, 1, 3.14);
...
TEST_P(InducedSubgraphViewGTest, testNodeIterator) {
    ...
    InducedSubgraphView G(this->Ghouse);
    testForward(G);
    testBackward(G);
...
TEST_P(InducedSubgraphViewGTest, testEdgeIterator) {
    ...
    auto doTests = [&](const InducedSubgraphView &G) {
        testForward(G);
        testBackward(G);
...
TEST_P(InducedSubgraphViewGTest, forNodesWhile) {
    count n = 100;
    InducedSubgraphView G = createInducedSubgraphView(n);
    count stopAfter = 10;
    count nodesSeen = 0;
...
TEST_P(InducedSubgraphViewGTest, testEdgeIndexGenerationDirected) {
    InducedSubgraphView G = InducedSubgraphView(10, false, true);
    G.addEdge(2, 0);
    G.addEdge(2, 1);
    G.addEdge(2, 2);
    G.addEdge(5, 6);
...
TEST_P(InducedSubgraphViewGTest, testEdgeIndexGenerationUndirected) {
    InducedSubgraphView G = InducedSubgraphView(10, false, false);
...
TEST_P(InducedSubgraphViewGTest, testEdgeIndexResolver) {
    InducedSubgraphView G = createInducedSubgraphView(10);
    G.indexEdges();
...
TEST_P(InducedSubgraphViewGTest, testForEdgesWithIds) {
    std::vector<InducedSubgraphView> graphs;
...
TEST_P(InducedSubgraphViewGTest, testForWeightedEdgesWithIds) {
    std::vector<InducedSubgraphView> graphs;
    graphs.emplace_back(10, false, false);
    graphs.emplace_back(10, false, true);
    graphs.emplace_back(10, true, false);
...
TEST_P(InducedSubgraphViewGTest, testParallelForEdgesWithIds) {
    std::vector<InducedSubgraphView> graphs;
    graphs.emplace_back(10, false, false);
    graphs.emplace_back(10, false, true);
    graphs.emplace_back(10, true, false);
...
TEST_P(InducedSubgraphViewGTest, testParallelForWeightedEdgesWithIds) {
    std::vector<InducedSubgraphView> graphs;
    graphs.emplace_back(10, false, false);
    graphs.emplace_back(10, false, true);
    graphs.emplace_back(10, true, false);
...
/*TEST_P(GraphGTest, testInForEdgesUndirected) {
  ...
  InducedSubgraphView G = reader.read("input/PGPgiantcompo.graph");
...
TEST_P(InducedSubgraphViewGTest, testSortEdges) {
    InducedSubgraphView G = this->Ghouse;
...
TEST_P(InducedSubgraphViewGTest, testEdgeIdsSortingAfterRemove) {
    constexpr node n = 100;

    Aux::Random::setSeed(42, true);
    InducedSubgraphView G = createInducedSubgraphView(n, 10 * n);
    G.sortEdges();
    G.indexEdges();
    auto original = G;
...
TEST_P(InducedSubgraphViewGTest, testEdgeIdsConsistencyAfterRemove) {
    constexpr node n = 100;
...
TEST_P(InducedSubgraphViewGTest, testEdgeIdsAfterRemoveWithoutSortingOrIDs) {
    constexpr node n = 100;
...
TEST(GraphGTest, testSortNeighborsDirectedGraph) {
    InducedSubgraphView G(6, false, true);
    G.addEdge(0, 3);
    G.addEdge(0, 5);
    G.addEdge(0, 4);
    G.addEdge(1, 3);
...
TEST(GraphGTest, testSortNeighborsWeightedDirectedGraphByWeights) {
    InducedSubgraphView G(6, true, true);
    G.addEdge(0, 3, 1.0);
    G.addEdge(0, 5, 3.0);
    G.addEdge(0, 4, 4.0);
    G.addEdge(0, 1, 12.0);
...
TEST(GraphGTest, testSortNeighborsWeightedDirectedIndexedGraph) {
    InducedSubgraphView G(6, true, true, true);
    G.addEdge(0, 3, 1.0);
    G.addEdge(0, 5, 3.0);
    G.addEdge(0, 4, 4.0);
    G.addEdge(0, 1, 12.0);
